...
victor_model=pickle.load(open("rf_model_new","rb"))
victor_transformer = pickle.load(open('transformer', 'rb'))
...
df2 = victor_transformer.transform(df)

st.subheader("Press predict if configuration is okay")

if st.button("Predict"):
    prediction = victor_model.predict(df2)
